...
export default function AddExperience({ onSuccess }: AddExperienceFormProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!company.trim() || !branch.trim() || !position.trim() || !startDate || !endDate) {
                ...
                >
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbSeparator />
                            <BreadcrumbItem>
                                <BreadcrumbPage className={`${isDarkMode ? " text-white" : " text-black"}`}>EXPERIENCE</BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
