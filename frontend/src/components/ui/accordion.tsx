      ...
      {items.map((item) => {
        ...
        return (
          ...
          >
            ...
            >
              <span className={`text-lg font-medium  group-hover:text-indigo-500 transition-colors ${isDarkMode ? "bg-[#101010] text-white" : "bg-white text-black"}`}>
                {item.title}
              </span>
